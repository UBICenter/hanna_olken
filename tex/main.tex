...
considering total 2018 resources from the Supplemental Poverty Measure (SPM) 
\cite{spm}.
I divide data by "SPM unit," a type of household unit created by the Census 
Bureau to estimate groups that share resources,
and divide each SPM unit's income after taxes and transfers ("income") by the 
...
exponentiating $e$ by the result.
...
\captionof{figure}{CRRA by share given transfer, 0.2\% of GDP, low noise}
